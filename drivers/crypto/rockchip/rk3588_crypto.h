...
#define RK_CRYPTO_AES_ECB		(RK_CRYPTO_AES | RK_CRYPTO_MODE_ECB)
#define RK_CRYPTO_AES_CBC		(RK_CRYPTO_AES | RK_CRYPTO_MODE_CBC)
#define RK_CRYPTO_AES_XTS		(RK_CRYPTO_AES | RK_CRYPTO_XTS)
...
#define RK_CRYPTO_CH4_KEY0		0x01c0
