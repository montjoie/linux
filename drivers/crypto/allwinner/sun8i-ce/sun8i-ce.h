...
/*
 * struct sun8i_ss_ctx - TODO
 * @base:
 * @busclk:
 * @ssclk:
 * @mbusclk:	An optional clock
 * @reset:
 * @dev:
 * @res:
...
/*
 * struct sun8i_tfm_rsa_ctx - TODO
 * @fallback:
 * @rsa_priv_key:	used for fallback
 * @rsa_pub_key:	used for fallback
 * @key_len:		used for fallback
 */
